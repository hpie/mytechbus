...
CREATE TABLE IF NOT EXISTS `route_fare_matrix` (
  ...
  `journey_type` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ONWARD, RETURN, CIRCULAR, Routes will not swap in CIRCULAR',
  ...
  `operator_message` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'This is message to be shown on ticket',
