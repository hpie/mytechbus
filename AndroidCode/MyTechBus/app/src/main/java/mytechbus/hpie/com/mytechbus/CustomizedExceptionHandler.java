...
public class CustomizedExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    public CustomizedExceptionHandler(Context mContext) {
    ...
    public void uncaughtException(Thread t, Throwable e) {
        ...
        Log.e("myLogs","Cutom exception called");
...
//Used only to prevent from any code getting executed.
    ...
    private void writeToFile(String currentStacktrace) {
        try {
            Log.e("myLogs","ExceptionHandler" + currentStacktrace);
            /*
            ...
            */
            ...
            fIleOperations.writeErrorToFile(filename, currentStacktrace, lContext, "1");
            ...
            */
            ...
            Log.e("myLogs","ExceptionHandler" + e.getMessage());
        }
    }
